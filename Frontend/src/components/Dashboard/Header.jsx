              ...
              <nav className="navbar navbar-expand">
                <div className="collapse navbar-collapse justify-content-between">
                  ...
                  <ul className="navbar-nav header-right">
                    <li className="nav-item dropdown notification_dropdown sm-search">
                          ...
                          <ul className="timeline">
                            <li>
                              <div className="timeline-panel">
                                ...
                                <div className="media-body ms-2">
                                  <h6 className="mb-1">LTC in DexignLab</h6>
                            ...
                            <li>
                              <div className="timeline-panel">
                                ...
                                <div className="media-body ms-2">
                                  <h6 className="mb-1">BTC/USD in DexignLab</h6>
                                  <small className="d-block">#0001</small>
                                </div>
                              </div>
                            </li>
                            <li>
                              <div className="timeline-panel">
                                ...
                                <div className="media-body ms-2">
                                  <h6 className="mb-1">Dlab Meeting</h6>
                                  <small className="d-block">#0001</small>
                                </div>
                              </div>
                            </li>
                    ...
                    {/* <li className="nav-item dropdown notification_dropdown">
                      ...
                      <div className="dropdown-menu dropdown-menu-end ms-3">
                        <div
                          id="DZ_W_TimeLine02"
