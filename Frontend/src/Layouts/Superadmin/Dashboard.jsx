...
const Dashboard = () => {
  ...
  const getdashboard = async () => {
    try {
      ...
      const response = await Superadmindashboarddata(data);
                  ...
                  <div className="card-header border-0 pb-0">
                    <div className="chart-num">
                      ...
                      <h2 className="font-w600 mb-0">
                        {countdata.TotalAdminCount && countdata.TotalAdminCount}
                      </h2>
                    </div>
                ...
                <div className="card card-box bg-secondary bg-pink">
                  <div className="card-header border-0 pb-0">
                    <div className="chart-num">
                      ...
                      <h2 className="font-w600 mb-0">
                        {countdata.TotalActiveAdminCount &&
                          countdata.TotalActiveAdminCount}
                      </h2>
                    </div>
                ...
                <div className="card card-box bg-secondary bg-dark">
                  <div className="card-header border-0 pb-0">
                    <div className="chart-num">
                      ...
                      <h2 className="font-w600 mb-0">
                        {countdata.TotalInActiveAdminCount &&
                          countdata.TotalInActiveAdminCount}
                      </h2>
                    </div>
                    <div className="dlab-swiper-circle">
