    ...
    <div>
      <div className="authincation d-flex flex-column flex-lg-row flex-column-fluid">
        <div className="login-aside text-center  d-flex flex-column flex-row-auto">
          ...
          >
            <img className="img1 move-1" src="images/background/pic3.png" alt="" />
            <img className="img2 move-2" src="images/background/pic4.png" alt="" />
            <img className="img3 move-3" src="images/background/pic5.png" alt="" />
          </div>
        </div>
            ...
            <div className="authincation-content style-2">
              <div className="row no-gutters">
                <div className="col-xl-12 tab-content">
                  ...
                  >
                    <form action="https://jiade.dexignlab.com/xhtml/index.html">
                      ...
                      <div className="row mb-4">
                        ...
                        <div className="col-xl-6 col-12">
                          <a
                            href="javascript:void(0);"
                            className="btn btn-outline-dark btn-sm btn-block mt-xl-0 mt-3"
                          >
                            <svg
                              className="me-1"
                              xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    ...
                    <a href="javascript:void(0);" className="text-primary mx-5">
                      Plans
                    </a>
                    <a href="javascript:void(0);" className="text-primary">
                      Contact Us
